...
public interface CategoriesDAO {
     ...
     */
    void agregarCategoria(int id, String value, String description, Status status, Date creationdate, Date modificationdate) throws PersistenceException;
     ...
     * @throws PersistenceException controlador de excepciones
     */
    void ModificarCategoria(String value, String descripcion, Status estado) throws PersistenceException;
