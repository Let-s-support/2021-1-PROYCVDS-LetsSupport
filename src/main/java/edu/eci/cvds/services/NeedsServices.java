...
public interface NeedsServices {
     ...
     */
    void agregarNecesidades(int id, String value, String description, int status, Date creationdate, Date modificationdate, int category_id, int urgencia) throws ServicesException;
